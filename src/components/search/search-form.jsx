        ...
        <>
            <Dialog>
                <DialogTrigger asChild>
                    <Button
                        className="inline-flex items-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground px-4 py-2 relative h-8 w-full justify-start rounded-[0.5rem] bg-background text-base font-normal text-muted-foreground shadow-none sm:pr-12 md:w-40 lg:w-64">
                ...
                <DialogContent className="sm:max-w-[825px] min-[400px]:max-w-[360px] rounded-xl">
                    <DialogHeader>
                        <DialogTitle>Search form</DialogTitle>
                        <DialogDescription>
